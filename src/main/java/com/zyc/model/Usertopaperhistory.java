...
public class Usertopaperhistory {
    ...
    public Usertopaperhistory(Integer usertopaperid, Integer userid, Integer paperid, Double value, Date startdate, Date enddate) {
